...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/ActiveGesturesRegistry.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s({
    "ActiveGesturesRegistry": ()=>ActiveGesturesRegistry
});
...
class ActiveGesturesRegistry {
   ...
   */ unregisterElement(element) {
    ...
    constructor(){
        /** Map of elements to their active gestures */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "activeGestures", (()=>new Map())());
    }
}
}),
"[project]/node_modules/@mui/x-internal-gestures/esm/core/KeyboardManager.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class KeyboardManager {
   ...
   */ constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "pressedKeys", (()=>new Set())());
        /**
   * Handle keydown events
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleKeyDown", (event)=>{
            this.pressedKeys.add(event.key);
        });
        /**
   * Handle keyup events
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleKeyUp", (event)=>{
            this.pressedKeys.delete(event.key);
        });
        /**
   * Clear all pressed keys
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "clearKeys", ()=>{
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/PointerManager.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class PointerManager {
   ...
   */ destroy() {
    ...
    constructor(options){
        /** Root element where pointer events are captured */ /** CSS touch-action property value applied to the root element */ /** Whether to use passive event listeners */ /** Whether to prevent interrupt events like blur or contextmenu */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "preventEventInterruption", true);
        /** Map of all currently active pointers by their pointerId */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "pointers", (()=>new Map())());
        /** Set of registered gesture handlers that receive pointer events */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "gestureHandlers", (()=>new Set())());
        /**
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleInterruptEvents", (event)=>{
            ...
            if (this.pointers.size > 0 && firstPointer) {
                ...
                for (const [pointerId, pointer] of this.pointers.entries()){
                    const updatedPointer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({}, pointer, {
                        type: 'forceCancel'
                    });
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handlePointerEvent", (event)=>{
        ...
        var _options_root;
        this.root = (_options_root = options.root) !== null && _options_root !== void 0 ? _options_root : document.getRootNode({
            composed: true
        });
        this.touchAction = options.touchAction || 'auto';
        var _options_passive;
        this.passive = (_options_passive = options.passive) !== null && _options_passive !== void 0 ? _options_passive : false;
        var _options_preventEventInterruption;
        this.preventEventInterruption = (_options_preventEventInterruption = options.preventEventInterruption) !== null && _options_preventEventInterruption !== void 0 ? _options_preventEventInterruption : false;
        this.setupEventListeners();
    }
}
}),
"[project]/node_modules/@mui/x-internal-gestures/esm/core/GestureManager.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$ActiveGesturesRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/ActiveGesturesRegistry.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$KeyboardManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/KeyboardManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/PointerManager.js [app-client] (ecmascript)");
;
;
;
;
class GestureManager {
   ...
   */ setGestureOptions(gestureName, element, options) {
        ...
        const event = new CustomEvent("".concat(gestureName, "ChangeOptions"), {
            detail: options,
            bubbles: false,
            cancelable: false,
            composed: false
   ...
   */ setGestureState(gestureName, element, state) {
        ...
        const event = new CustomEvent("".concat(gestureName, "ChangeState"), {
            detail: state,
            bubbles: false,
            cancelable: false,
            composed: false
   ...
   */ registerElement(gestureNames, element, options) {
        ...
        gestureNames.forEach((name)=>{
            const gestureOptions = options === null || options === void 0 ? void 0 : options[name];
   ...
   */ constructor(options){
        /** Repository of gesture templates that can be cloned for specific elements */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "gestureTemplates", (()=>new Map())());
        /** Maps DOM elements to their active gesture instances */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "elementGestureMap", (()=>new Map())());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "activeGesturesRegistry", (()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$ActiveGesturesRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveGesturesRegistry"]())());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "keyboardManager", (()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$KeyboardManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KeyboardManager"]())());
        // Initialize the PointerManager
        this.pointerManager = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerManager"]({
            root: options.root,
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/eventList.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/Gesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$eventList$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/eventList.js [app-client] (ecmascript)");
;
;
class Gesture {
    /**
   ...
   */ init(element, pointerManager, gestureRegistry, keyboardManager) {
        ...
        const changeOptionsEventName = "".concat(this.name, "ChangeOptions");
        this.element.addEventListener(changeOptionsEventName, this.handleOptionsChange.bind(this));
        const changeStateEventName = "".concat(this.name, "ChangeState");
   ...
   */ updateOptions(options) {
        var _options_preventDefault;
        // Update common options
        this.preventDefault = (_options_preventDefault = options.preventDefault) !== null && _options_preventDefault !== void 0 ? _options_preventDefault : this.preventDefault;
        var _options_stopPropagation;
        this.stopPropagation = (_options_stopPropagation = options.stopPropagation) !== null && _options_stopPropagation !== void 0 ? _options_stopPropagation : this.stopPropagation;
        var _options_preventIf;
        this.preventIf = (_options_preventIf = options.preventIf) !== null && _options_preventIf !== void 0 ? _options_preventIf : this.preventIf;
        var _options_requiredKeys;
        this.requiredKeys = (_options_requiredKeys = options.requiredKeys) !== null && _options_requiredKeys !== void 0 ? _options_requiredKeys : this.requiredKeys;
        var _options_pointerMode;
        this.pointerMode = (_options_pointerMode = options.pointerMode) !== null && _options_pointerMode !== void 0 ? _options_pointerMode : this.pointerMode;
    }
    /**
   ...
   */ getTargetElement(event) {
    ...
    /** Whether the gesture is currently active */ get isActive() {
        var _this_gesturesRegistry_isGestureActive;
        return (_this_gesturesRegistry_isGestureActive = this.gesturesRegistry.isGestureActive(this.element, this)) !== null && _this_gesturesRegistry_isGestureActive !== void 0 ? _this_gesturesRegistry_isGestureActive : false;
    }
    /**
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "customData", {});
        if (!options || !options.name) {
            throw new Error('Gesture must be initialized with a valid name.');
        }
        if (options.name in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$eventList$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["eventList"]) {
        ...
        var _options_preventDefault;
        this.preventDefault = (_options_preventDefault = options.preventDefault) !== null && _options_preventDefault !== void 0 ? _options_preventDefault : false;
        var _options_stopPropagation;
        this.stopPropagation = (_options_stopPropagation = options.stopPropagation) !== null && _options_stopPropagation !== void 0 ? _options_stopPropagation : false;
        var _options_preventIf;
        this.preventIf = (_options_preventIf = options.preventIf) !== null && _options_preventIf !== void 0 ? _options_preventIf : [];
        var _options_requiredKeys;
        this.requiredKeys = (_options_requiredKeys = options.requiredKeys) !== null && _options_requiredKeys !== void 0 ? _options_requiredKeys : [];
        var _options_pointerMode;
        this.pointerMode = (_options_pointerMode = options.pointerMode) !== null && _options_pointerMode !== void 0 ? _options_pointerMode : [];
    }
}
}),
"[project]/node_modules/@mui/x-internal-gestures/esm/core/PointerGesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$Gesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/Gesture.js [app-client] (ecmascript)");
;
;
class PointerGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$Gesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Gesture"] {
    init(element, pointerManager, gestureRegistry, keyboardManager) {
    ...
    updateOptions(options) {
        ...
        var _options_minPointers;
        this.minPointers = (_options_minPointers = options.minPointers) !== null && _options_minPointers !== void 0 ? _options_minPointers : this.minPointers;
        var _options_maxPointers;
        this.maxPointers = (_options_maxPointers = options.maxPointers) !== null && _options_maxPointers !== void 0 ? _options_maxPointers : this.maxPointers;
    }
    /**
   ...
   */ constructor(options){
        super(options), /** Function to unregister from the PointerManager when destroying this gesture */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "unregisterHandler", null), /** The original target element when the gesture began, used to prevent limbo state if target is removed */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "originalTarget", null);
        var _options_minPointers;
        this.minPointers = (_options_minPointers = options.minPointers) !== null && _options_minPointers !== void 0 ? _options_minPointers : 1;
        var _options_maxPointers;
        this.maxPointers = (_options_maxPointers = options.maxPointers) !== null && _options_maxPointers !== void 0 ? _options_maxPointers : Infinity;
    }
}
}),
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/calculateCentroid.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/createEventName.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/gestures/MoveGesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/PointerGesture.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/calculateCentroid.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$createEventName$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/createEventName.js [app-client] (ecmascript)");
;
;
;
;
class MoveGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    clone(overrides) {
        return new MoveGesture((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
            name: this.name,
   ...
   */ emitMoveEvent(element, phase, pointers, event) {
        const currentPosition = this.state.lastPosition || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCentroid"])(pointers);
        ...
        const eventName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$createEventName$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEventName"])(this.name, phase);
   ...
   */ // Store bound event handlers to properly remove them
    constructor(options){
        super(options), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "state", {
            lastPosition: null
        });
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/getDirection.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/isDirectionAllowed.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/gestures/PanGesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/calculateCentroid.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$createEventName$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/createEventName.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$getDirection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/getDirection.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$isDirectionAllowed$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/isDirectionAllowed.js [app-client] (ecmascript)");
;
;
;
;
class PanGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    clone(overrides) {
        return new PanGesture((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
            name: this.name,
            preventDefault: this.preventDefault,
            stopPropagation: this.stopPropagation,
            threshold: this.threshold,
    ...
    resetState() {
        this.isActive = false;
        this.state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({}, this.state, {
        ...
        switch(event.type){
            case 'pointerdown':
                if (!this.isActive && !this.state.startCentroid) {
                    ...
                    this.state.startCentroid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCentroid"])(relevantPointers);
                    this.state.lastCentroid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({}, this.state.startCentroid);
                }
                break;
            case 'pointermove':
                if (this.state.startCentroid && relevantPointers.length >= this.minPointers) {
                    // Calculate current centroid
                    const currentCentroid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCentroid"])(relevantPointers);
                    ...
                    var _this_state_lastCentroid;
                    // Determine movement direction
                    const moveDirection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$getDirection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDirection"])((_this_state_lastCentroid = this.state.lastCentroid) !== null && _this_state_lastCentroid !== void 0 ? _this_state_lastCentroid : this.state.startCentroid, currentCentroid);
   ...
   */ emitPanEvent(element, phase, pointers, event, currentCentroid) {
        var _this_state_lastDeltas, _this_state_lastDeltas1;
        if (!this.state.startCentroid) {
            return;
        }
        var _this_state_lastDeltas_x;
        const deltaX = (_this_state_lastDeltas_x = (_this_state_lastDeltas = this.state.lastDeltas) === null || _this_state_lastDeltas === void 0 ? void 0 : _this_state_lastDeltas.x) !== null && _this_state_lastDeltas_x !== void 0 ? _this_state_lastDeltas_x : 0;
        var _this_state_lastDeltas_y;
        const deltaY = (_this_state_lastDeltas_y = (_this_state_lastDeltas1 = this.state.lastDeltas) === null || _this_state_lastDeltas1 === void 0 ? void 0 : _this_state_lastDeltas1.y) !== null && _this_state_lastDeltas_y !== void 0 ? _this_state_lastDeltas_y : 0;
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/getDistance.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/calculateAverageDistance.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "calculateAverageDistance": ()=>calculateAverageDistance
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$getDistance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/getDistance.js [app-client] (ecmascript)");
;
function calculateAverageDistance(pointers) {
    ...
    for(let i = 0; i < pointers.length; i += 1){
        for(let j = i + 1; j < pointers.length; j += 1){
            totalDistance += (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$getDistance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDistance"])({
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/getPinchDirection.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "getPinchDirection": ()=>getPinchDirection
});
...
"[project]/node_modules/@mui/x-internal-gestures/esm/core/gestures/PinchGesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/PointerGesture.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateAverageDistance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/calculateAverageDistance.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/calculateCentroid.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$createEventName$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/createEventName.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$getPinchDirection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/x-internal-gestures/esm/core/utils/getPinchDirection.js [app-client] (ecmascript)");
;
;
;
;
class PinchGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    clone(overrides) {
        return new PinchGesture((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
            name: this.name,
            preventDefault: this.preventDefault,
            stopPropagation: this.stopPropagation,
            threshold: this.threshold,
        ...
        switch(event.type){
            case 'pointerdown':
                if (relevantPointers.length >= 2 && !this.isActive) {
                    ...
                    const initialDistance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateAverageDistance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateAverageDistance"])(relevantPointers);
            ...
            case 'pointermove':
                if (this.state.startDistance && relevantPointers.length >= this.minPointers) {
                    ...
                    const currentDistance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateAverageDistance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateAverageDistance"])(relevantPointers);
            ...
            case 'forceCancel':
                if (this.isActive) {
                    ...
                    if (remainingPointers.length < this.minPointers) {
                        ...
                        const newDistance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateAverageDistance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateAverageDistance"])(remainingPointers);
   ...
   */ emitPinchEvent(element, phase, pointers, event) {
        // Calculate current centroid
        const centroid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCentroid"])(pointers);
        // Create custom event data
        ...
        const customEventData = {
            ...
            activeGestures,
            direction: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$getPinchDirection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPinchDirection"])(this.state.velocity),
            customData: this.customData
        };
   ...
   */ constructor(options){
        var _options_minPointers;
        super((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({}, options, {
            minPointers: (_options_minPointers = options.minPointers) !== null && _options_minPointers !== void 0 ? _options_minPointers : 2
        ...
        this.threshold = (_options_threshold = options.threshold) !== null && _options_threshold !== void 0 ? _options_threshold : 0;
    }
}
}),
"[project]/node_modules/@mui/x-internal-gestures/esm/core/gestures/PressGesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
class PressGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    clone(overrides) {
        return new PressGesture((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
            name: this.name,
            preventDefault: this.preventDefault,
            stopPropagation: this.stopPropagation,
            minPointers: this.minPointers,
    ...
    updateOptions(options) {
        ...
        this.duration = (_options_duration = options.duration) !== null && _options_duration !== void 0 ? _options_duration : this.duration;
        var _options_maxDistance;
        this.maxDistance = (_options_maxDistance = options.maxDistance) !== null && _options_maxDistance !== void 0 ? _options_maxDistance : this.maxDistance;
    }
    resetState() {
        this.clearPressTimer();
        this.isActive = false;
        ...
        switch(event.type){
            case 'pointerdown':
                if (!this.isActive && !this.state.startCentroid) {
                    // Calculate and store the starting centroid
                    this.state.startCentroid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCentroid"])(relevantPointers);
                    this.state.lastPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({}, this.state.startCentroid);
            ...
            case 'pointermove':
                if (this.isActive && this.state.startCentroid) {
                    ...
                    const currentPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCentroid"])(relevantPointers);
                    this.state.lastPosition = currentPosition;
   ...
   */ constructor(options){
        ...
        var _options_duration;
        this.duration = (_options_duration = options.duration) !== null && _options_duration !== void 0 ? _options_duration : 500;
        var _options_maxDistance;
        this.maxDistance = (_options_maxDistance = options.maxDistance) !== null && _options_maxDistance !== void 0 ? _options_maxDistance : 10;
    }
}
}),
"[project]/node_modules/@mui/x-internal-gestures/esm/core/gestures/TapGesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
class TapGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    clone(overrides) {
        return new TapGesture((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
            name: this.name,
            preventDefault: this.preventDefault,
            stopPropagation: this.stopPropagation,
            minPointers: this.minPointers,
    ...
    updateOptions(options) {
        ...
        this.maxDistance = (_options_maxDistance = options.maxDistance) !== null && _options_maxDistance !== void 0 ? _options_maxDistance : this.maxDistance;
        var _options_taps;
        this.taps = (_options_taps = options.taps) !== null && _options_taps !== void 0 ? _options_taps : this.taps;
    }
    resetState() {
        this.isActive = false;
        this.state = {
   ...
   */ cancelTap(element, pointers, event) {
        if (this.state.startCentroid || this.state.lastPosition) {
            ...
            const eventName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$createEventName$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEventName"])(this.name, 'cancel');
            const domEvent = new CustomEvent(eventName, {
                bubbles: true,
                cancelable: true,
                composed: true,
   ...
   */ constructor(options){
        ...
        this.maxDistance = (_options_maxDistance = options.maxDistance) !== null && _options_maxDistance !== void 0 ? _options_maxDistance : 10;
        var _options_taps;
        this.taps = (_options_taps = options.taps) !== null && _options_taps !== void 0 ? _options_taps : 1;
    }
}
}),
"[project]/node_modules/@mui/x-internal-gestures/esm/core/gestures/TurnWheelGesture.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "TurnWheelGesture": ()=>TurnWheelGesture
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@babel/runtime/helpers/esm/extends.js [app-client] (ecmascript)");
/**
...
;
;
class TurnWheelGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$Gesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Gesture"] {
    clone(overrides) {
        return new TurnWheelGesture((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$extends$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
            name: this.name,
            preventDefault: this.preventDefault,
            stopPropagation: this.stopPropagation,
    ...
    updateOptions(options) {
        super.updateOptions(options);
        var _options_sensitivity;
        this.sensitivity = (_options_sensitivity = options.sensitivity) !== null && _options_sensitivity !== void 0 ? _options_sensitivity : this.sensitivity;
        var _options_max;
        this.max = (_options_max = options.max) !== null && _options_max !== void 0 ? _options_max : this.max;
        var _options_min;
        this.min = (_options_min = options.min) !== null && _options_min !== void 0 ? _options_min : this.min;
        var _options_initialDelta;
        this.initialDelta = (_options_initialDelta = options.initialDelta) !== null && _options_initialDelta !== void 0 ? _options_initialDelta : this.initialDelta;
        var _options_invert;
        this.invert = (_options_invert = options.invert) !== null && _options_invert !== void 0 ? _options_invert : this.invert;
    }
    /**
   ...
   */ emitWheelEvent(pointers, event) {
        ...
        const centroid = pointers.length > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$calculateCentroid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCentroid"])(pointers) : {
            x: event.clientX,
            y: event.clientY
        };
        // Get list of active gestures
        ...
        // Event names to trigger
        const eventName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$createEventName$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEventName"])(this.name, 'ongoing');
        // Dispatch custom events on the element
        const domEvent = new CustomEvent(eventName, {
            bubbles: true,
            cancelable: true,
   ...
   */ // Store bound event handlers to properly remove them
    constructor(options){
        ...
        var _options_sensitivity;
        this.sensitivity = (_options_sensitivity = options.sensitivity) !== null && _options_sensitivity !== void 0 ? _options_sensitivity : 1;
        var _options_max;
        this.max = (_options_max = options.max) !== null && _options_max !== void 0 ? _options_max : Number.MAX_SAFE_INTEGER;
        var _options_min;
        this.min = (_options_min = options.min) !== null && _options_min !== void 0 ? _options_min : Number.MIN_SAFE_INTEGER;
        var _options_initialDelta;
        this.initialDelta = (_options_initialDelta = options.initialDelta) !== null && _options_initialDelta !== void 0 ? _options_initialDelta : 0;
        var _options_invert;
        this.invert = (_options_invert = options.invert) !== null && _options_invert !== void 0 ? _options_invert : false;
...
//# sourceMappingURL=node_modules_%40mui_x-internal-gestures_esm_core_2db3e4fd._.js.map