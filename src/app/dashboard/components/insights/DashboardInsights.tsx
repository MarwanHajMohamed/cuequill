  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3 flex-wrap mb-3">
        <div className={`text-[10px] md:text-[11px] uppercase tracking-[0.18em] font-medium ${tone.eyebrow}`}>
          Daily risk budget
        </div>
...
function RankGroup({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className={`text-[10px] uppercase tracking-[0.14em] font-medium ${accent}`}>
        {label}
      </div>
      {rows.map((r) => {
