...
//
// 3D treatment: a radial-lit background for depth, the quill split into a
// lit (left) and shaded (right) vane so it reads as a folded feather
// rather than a flat silhouette, plus a teal spine + nib accent.
